  ...
  return (
    <RadixAlertDialog.Root open={open} onOpenChange={(v) => !v && onCancel()}>
      <RadixAlertDialog.Portal>
        <RadixAlertDialog.Overlay className="fixed inset-0 z-50 bg-espresso/50 animate-fade-in" />
        <RadixAlertDialog.Content className="fixed start-1/2 top-1/2 z-50 w-[min(26rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-latte bg-paper p-6 shadow-lg animate-scale-in">
